...
static const char* Message_docstring = "Root of all messages.\n\nAs in JMS, a message is comprised of 3 parts: "
									   "CMS-specific headers, user-defined properties, and the body.";
static const char* Message_acknowledge_docstring =  "Acknowledges all consumed messages of the session of this consumed message.\n\n"
...
static const char* Message_clearBody_docstring = "Clears out the body of the message.\n\nThis does not clear the headers or properties.";
static const char* Message_clearProperties_docstring =  "Clears out the message body.\n\nClearing a message's body does not clear its "
...
static const char* Message_expiration_docstring = "Gets the message's expiration value.\n\nWhen a message is sent, the expiration "
...
static const char* Message_messageID_docstring = "The C{messageID} header field contains a value that uniquely identifies each message"
...
static const char* Message_priority_docstring = "Gets the message priority level.\n\nThe CMS API defines ten levels of priority "
...
static const char* Message_redelivered_docstring =  "Gets an indication of whether this message is being redelivered.\n\nIf a client "
...
static const char* Message_timestamp_docstring = "Gets the message timestamp.\n\nThe C{timestamp} header field contains the time a "
...
static const char* Message_replyTo_docstring =    "The L{Destination} object to which a reply to this message should be sent."
...
static const char* Message_destination_docstring = "Returns the L{Destination} object for this message.\n\nThe destination header "
...
static const char* Message_correlationID_docstring =  "The correlation ID for the message.\n\nA client can use the C{correlationID} "
													  ...
													  "non-portable.";
static const char* Message_type_docstring =	  "Sets the message type.\n\nSome CMS providers use a message repository that "
